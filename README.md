...
*   `src/app/actions.ts`: Implements Server Actions for device pairing, document deletes, and status updates.
...
*   `src/components/`: Modular React components (e.g., `DeviceTable.tsx`, `KnowledgeBase.tsx`, `UploadModal.tsx`).
