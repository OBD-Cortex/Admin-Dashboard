                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className="w-full px-3 py-2 text-xs border border-border bg-background text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-secondary focus:border-secondary transition-all rounded-xl font-sans"
                            required
                        />
                    ...
                    <div className="flex justify-end gap-3 pt-2">
                        ...
                        <button
                            ...
                            className="h-8 bg-secondary hover:bg-secondary/90 text-secondary-foreground disabled:opacity-50 px-4 text-[10px] font-bold text-primary-foreground transition-all cursor-pointer select-none flex items-center gap-1.5 rounded-xl"
                        >
                            {loading && (
                                <svg className="h-3 w-3 animate-spin text-secondary-foreground" fill="none" viewBox="0 0 24 24">
